...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "information" (
  	...
  	"socials_github" varchar DEFAULT '' NOT NULL,
  	"socials_linkedin" varchar DEFAULT '' NOT NULL,
  	"socials_calandly" varchar DEFAULT '' NOT NULL,
  	"socials_phone" varchar DEFAULT '' NOT NULL,
  	"socials_email" varchar DEFAULT '' NOT NULL,
  	"slug" varchar,
  	"slug_lock" boolean DEFAULT true,
  ...
  ALTER TABLE "projects" ADD CONSTRAINT "projects_feature_image_id_media_id_fk" FOREIGN KEY ("feature_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "information" ADD CONSTRAINT "information_resume_id_media_id_fk" FOREIGN KEY ("resume_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "experience_slug_idx" ON "experience" USING btree ("slug");
  ...
  CREATE INDEX "projects_feature_image_idx" ON "projects" USING btree ("feature_image_id");
  ...
  CREATE INDEX "information_resume_idx" ON "information" USING btree ("resume_id");
  CREATE INDEX "information_slug_idx" ON "information" USING btree ("slug");`)
}
